...
namespace DrakeQuest.Configuration.Design
{
    ...
    /// <summary>
    /// Property descriptor for the <see cref="ApplicationElement"/>
    /// </summary>
    public sealed class ApplicationElementPropertyDescriptor : PropertyDescriptor
    {
        #region Attributes
        ...
        {
            get { return typeof(ApplicationElementCollection); }
        }
        ...
        {
            get { return typeof(ApplicationElement); }
        }
